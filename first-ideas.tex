...
\begin{prop}
  The category $\Idm J$ is symmetric monoidal closed.
\end{prop}
...
We additionally request that $\mathsf{lift}$ is a strong symmetric monoidal closed functor, in correspondence with $\eta$.
For instance,
\begin{mathpar}
...
\paragraph{Example with streams}
